...
<section class="liked-videos">
   ...
   <h1 class="heading">วิดีโอที่ชอบ</h1>
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">ดูวีดีโอ</a>
         <input type="submit" value="ลบ" class="inline-delete-btn" name="remove">
      </form>
   </div>
   <?php
            }
         }else{
            echo '<p class="emtpy">ไม่พบเนื้อหา!</p>';         
         }
      }
   }else{
      echo '<p class="empty">ยังไม่มีการเพิ่มลงในไลค์!</p>';
   }
   ?>
